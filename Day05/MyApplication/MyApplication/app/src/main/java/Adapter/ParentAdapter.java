...
public class ParentAdapter extends RecyclerView.Adapter<ParentAdapter.ParentViewHolder> {
    ...
    public ParentAdapter(Activity activity, Map<String, CategoryEntity> parentMap, Mode mode, OnChildClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ParentViewHolder holder, int position) {
        ...
        if (childList == null || childList.isEmpty()) {
            ...
            ChildAdapter adapter = new ChildAdapter(
                    ...
                    (staticUrl, gifUrl, name) -> {
                        // Gọi DetailActivity và chờ kết quả
        ...
        holder.testLog1.setOnClickListener(v -> {
            Context context = holder.itemView.getContext();
            MediaUtils mediaUtils = new MediaUtils();
            List<String> imageUris = mediaUtils.getNameImg(context);
            Log.d("TestDir", "onCreate: " + imageUris);
        });
    ...
    public static class ParentViewHolder extends RecyclerView.ViewHolder {
        TextView titleParent, seeAllTextView, testLog1;
        ...
        public ParentViewHolder(@NonNull View itemView) {
            ...
            testLog1 = itemView.findViewById(R.id.testLog1);
